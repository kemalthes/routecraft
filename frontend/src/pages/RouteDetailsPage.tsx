...
import { Button, Card, Descriptions, Image, Layout, List, Spin, Typography } from "antd";
  ...
  if (routeLoading) {
    ...
    content = (
        <div className="details-grid">
          <Card>
            ...
            <Descriptions bordered column={1} size="small">
              ...
              <Descriptions.Item label="Дистанция">
                {selectedRoute.distance.toFixed(1)} км
              </Descriptions.Item>
              <Descriptions.Item label="Длительность">
                {selectedRoute.durationMinutes} мин
              </Descriptions.Item>
              <Descriptions.Item label="Точек маршрута">
                {selectedRoute.locations.length}
              </Descriptions.Item>
            </Descriptions>
          </Card>
          ...
          <Card title="Отзывы">
            <List
                dataSource={selectedRoute.reviews ?? []}
